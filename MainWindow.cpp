...
void MainWindow::DefineMainWindowControls(HWND hWnd, HINSTANCE hInstance) {
    ...
    HWND weightLabel = controls.CreateControl(_T("STATIC"), _T("Waga [kg]"), WS_CHILD | WS_VISIBLE, 75, 100, 150, 20,
        hWnd, hInstance);
    HWND weightTextBox = controls.CreateControl(_T("EDIT"), NULL, WS_CHILD | WS_VISIBLE | WS_BORDER, 175, 100, 150, 20,
        hWnd, hInstance, ID_WEIGHT);

    HWND heightLabel = controls.CreateControl(_T("STATIC"), _T("Wzrost [cm]"), WS_CHILD | WS_VISIBLE, 75, 150, 150, 20,
        hWnd, hInstance);
    HWND heightTextBox = controls.CreateControl(_T("EDIT"), NULL, WS_CHILD | WS_VISIBLE | WS_BORDER, 175, 150, 150, 20,
        hWnd, hInstance, ID_HEIGHT);

    HWND confirmButton = controls.CreateControl(_T("BUTTON"), _T("Dalej"), WS_CHILD | WS_VISIBLE | WS_BORDER, 125, 225, 150, 20,
